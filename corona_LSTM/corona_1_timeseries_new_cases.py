# -*- coding: utf-8 -*-
"""
Created on Wed Mar 25 20:06:34 2020
...
path2 = r"C:\Users\ayanca\.spyder-py3\corona_LSTM\ourworldindata.org\full_data.csv"
...
data2['location'] = data2[data2['location'] == country]
...
result.plot.bar(color = 'red', label = 'Predicted New Case(s)')
data2[field].plot.line(color = 'blue', label = 'Actual New Case(s)')
plt.title('New Case(s) Prediction for '+ field)
plt.xlabel('Time')
plt.ylabel('Cases')
plt.legend()
plt.show()